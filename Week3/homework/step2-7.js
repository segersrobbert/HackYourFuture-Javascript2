...
const comment1 = 'In the first case: function f1 received  like parameter the value of 9 \
...
// eslint-disable-next-line no-multi-str
const comment2 = 'In the secod case: function f2 received like parameter the reference of the object "y" \
