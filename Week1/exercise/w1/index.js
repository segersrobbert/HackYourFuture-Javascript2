...
const selectButtonToChangeImage = document.getElementById('btn-changeImage');
...
selectButtonToChangeImage.addEventListener('click', changeImage);
...
const getToDoButtonClick = document.querySelector('#btn-addTodo');
...
getToDoButtonClick.addEventListener('click', addTodo);
